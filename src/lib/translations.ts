...
export const translations = {
  ru: {
    ...
    modalVisit: "Посетить сайт",
		playgroundTitle: "03. ТЕХНИЧЕСКАЯ ПЕСОЧНИЦА",
  ...
  en: {
    ...
    modalVisit: "Visit website",
		playgroundTitle: "03. TECHNICAL PLAYGROUND",
  ...
  es: {
    ...
    modalVisit: "Visitar sitio",
		 playgroundTitle: "03. LABORATORIO TÉCNICO",
